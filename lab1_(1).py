...
Original file is located at
    https://colab.research.google.com/drive/1pkNhiNzEpBaROj90hTviRvJUUr3oT1Dn
...
4# Prompt the user to enter values of different types
...
if side1 == side2 == side3:
    ...
    triangle_type = "Can be drawn with a given sides"
else:
    triangle_type = "Scalene"
...
if operation == "+":
    ...
    if num2 == 0:
      result = "This isn't possible to divide by 0"
